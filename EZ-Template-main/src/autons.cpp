...
void newrightside() {
  ...
  chassis.pid_drive_set(36.30_in, DRIVE_SPEED, true);
  chassis.pid_wait();

  chassis.pid_turn_set(163.50_deg, TURN_SPEED);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(-26.375_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(20.80_in, 127, true);
  chassis.pid_wait();

  descorer.set_value(false);
  pros::delay(100);

  chassis.pid_drive_set(10.50_in, 127, true);
  chassis.pid_wait();
