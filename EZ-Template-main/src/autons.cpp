...
void rightside() {
  ...
  chassis.pid_drive_set(-2.95_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  
  loaderclear.set_value(true);
  pros::delay(500);

  chassis.pid_drive_set(9.73_in, DRIVE_SPEED, true);
  pros::delay(1500);
  ...
  chassis.pid_drive_set(-25.65_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(10.50_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(1.875_in, DRIVE_SPEED, true);
  intake.move_velocity(-600);
  intake2.move_velocity(600);
  intake3.move_velocity(600);
  chassis.pid_wait();
...
void leftside() {
  ...
  chassis.pid_drive_set(-14.25_in, DRIVE_SPEED, true);
  chassis.pid_wait();
...
void skills() {
  ...
  chassis.pid_drive_set(96.5_in, DRIVE_SPEED, true);
  chassis.pid_wait();
